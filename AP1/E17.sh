#!/bin/bash
# Script per comprovar si estem executant com a superusuari root
...
# Comprova si et trobes executant l'script com a superusuari root (redundant)
if [ "$(id -u)" -eq 0 ]; then
    echo "Superusuari root ja està en execució."
else
    echo "Superusuari root no està en execució."
fi